public class Direction {
    ...
    public Direction invert() {
        int newChangeInRow = 0 - this.changeInRow;
        int newChangeInColumn = 0 - this.changeInColumn;
        Direction invertedDirection = new Direction(newChangeInRow, newChangeInColumn);
